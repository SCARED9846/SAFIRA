...
let handler = async (m, { conn, text }) => {
  ...
  if (new Date - user.prue < 90000) return await conn.reply(m.chat, `🙌 Ei, ESPERE ALGUNS MINUTOS PARA USAR OUTRO COMANDO, NÃO FAÇA SPAM`, fkontak, m)
  ...
  let up = `*${pickRandom(['Desativado', 'Habilitado', 'Ativo', 'Habilitado', 'Habilitado', 'Ativo 1', 'Habilitado', 'Desabilitado', 'Habilitado', 'Habilitado', 'Ativo 2', 'Habilitado', 'Habilitado', 'Habilitado', 'Desabilitado', 'Habilitado --', 'Habilitado', 'Habilitado []', 'Habilitado [--]', 'Ativo 4', 'Habilitado 1', 'Habilitado', 'Desabilitado', 'Habilitado', 'Habilitado', 'Habilitado ..1', 'Habilitado', 'Habilitado', 'Habilitado', 'Ativo 1-1', 'Habilitado', 'Habilitado', 'Habilitado', 'Ativo 1-2', 'Habilitado', 'Habilitado', 'Ativo 1-4', 'Habilitado', 'Habilitado', 'Desabilitado', 'Habilitado', 'Desabilitado', 'Habilitado', 'Ativo 1--', 'Habilitado', 'Habilitado', 'Ativo 3--', 'Desabilitado', 'Desabilitado', 'Ativo 3-2', 'Desabilitado'])}%*`
  ...
  let speed = `${neww - old}`
  let doxeo = `*_✅ Pessoa doxxeada com sucesso_*\n\n*_Tempo: ${speed} segundos!_*
...
handler.command = /^doxxear|doxear|doxeo|doxear|doxxeame|doxeame/i
handler.fail = null
