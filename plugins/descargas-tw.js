...
await conn.sendFile(m.chat, url, 'twitter' + (type == 'image' ? '.jpg' : '.mp4'), `✨ 𝙌𝙐𝘼𝙇𝙄𝘿𝘼𝘿𝙀 *:* 𝙌𝙐𝘼𝙇𝙄𝙏𝙔 *» ${quality}*\n${wm}`, m)
}
