...
if (!args[0]) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝙄𝙉𝘿𝙄𝙌𝙐𝙀 𝙐𝙈𝘼 𝙐𝙍𝙇 𝘿𝙊 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙋𝘼𝙍𝘼 𝘽𝘼𝙄𝙓𝘼𝙍\n𝙀𝙓𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} https://www.facebook.com/watch?v=636541475139`, fkontak, m)
if (!args[0].match(/www.facebook.com|fb.watch/g)) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝙄𝙉𝘿𝙄𝙌𝙐𝙀 𝙐𝙈𝘼 𝙐𝙍𝙇 𝘿𝙊 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙋𝘼𝙍𝘼 𝘽𝘼𝙄𝙓𝘼𝙍\n𝙀𝙓𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} https://www.facebook.com/watch?v=636541475139*`, fkontak, m)
try {
await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}𝙀𝙎𝙋𝙀𝙍𝙀 𝙐𝙈 𝙈𝙊𝙈𝙀𝙉𝙏𝙊, 𝙀𝙎𝙏𝙊𝙐 𝘽𝘼𝙄𝙓𝘼𝙉𝘿𝙊 𝙎𝙀𝙐 𝙑Í𝘿𝙀𝙊 𝘿𝙊 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆`, fkontak, m)
...
console.log('6 ' + err6)    
await m.reply(`${lenguajeGB['smsAvisoFG']()}𝘼𝙇𝙂𝙊 𝙎𝘼𝙄𝙐 𝙈𝘼𝙇, 𝙇𝙀𝙈𝘽𝙍𝙀-𝙎𝙀 𝘿𝙀 𝙐𝙎𝘼𝙍 𝙐𝙈 𝙇𝙄𝙉𝙆 𝘿𝙊 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙑𝘼𝙇𝙄𝘿𝙊`)
}}}}}}}
