...
𝙉𝙄𝙑𝙀𝙇 𝘿𝙀 𝘿𝙄𝙁𝙄𝘾𝙐𝙇𝘿𝘼𝘿𝙀 | 𝘿𝙄𝙁𝙁𝙄𝘾𝙐𝙇𝙏𝙔 
...
😼 𝙌𝙐𝘼𝙉𝙏𝙊 𝙈𝘼𝙄𝙊𝙍 𝘼 𝘿𝙄𝙁𝙄𝘾𝙐𝙇𝘿𝘼𝘿𝙀 𝙈𝘼𝙄𝙊𝙍 𝘼 𝙍𝙀𝘾𝙊𝙈𝙋𝙀𝙉𝙎𝘼
...
let id = m.chat
if (id in global.math) return conn.reply(m.chat, `${lenguajeGB['smsAvisoAG']()}\n\n𝙏𝙃𝙀𝙍𝙀 𝘼𝙍𝙀 𝙌𝙐𝙀𝙎𝙏𝙄𝙊𝙉𝙎 𝙒𝙄𝙏𝙃𝙊𝙐𝙏 𝘼𝙉𝙎𝙒𝙀𝙍𝙄𝙉𝙂 𝙄𝙉 𝙏𝙃𝙀 𝘾𝙃𝘼𝙏!!`, global.math[id][0])
//let ii = global.db.data.users[m.sender].limit += 10 math.dia
let math = genMath(mode)
global.math[id] = [
await conn.reply(m.chat, `𝙌𝙐𝘼𝙇 𝙊 𝙍𝙀𝙎𝙐𝙇𝙏𝘼𝘿𝙊 𝘿𝙀 *${math.str} = ?*
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
𝙏𝙀𝙈𝙋𝙊 | 𝙏𝙞𝙢𝙚
🧭 *${(math.time / 1000).toFixed(0)} 𝚜𝚎𝚐𝚞𝚗𝚍𝚘𝚜*
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝙀 𝘼 𝙀𝙎𝙎𝘼 𝙈𝙀𝙉𝙎𝘼𝙂𝙀𝙈 𝙋𝘼𝙍𝘼 𝙂𝘼𝙉𝙃𝘼𝙍. 🎉 
🏆 *${math.bonus} 𝙓𝙋*
`, m),
math, 4,
  
await conn.reply(m.chat, `⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝙀 𝘼 𝙀𝙎𝙎𝘼 𝙈𝙀𝙉𝙎𝘼𝙂𝙀𝙈 𝙋𝘼𝙍𝘼 𝙂𝘼𝙉𝙃𝘼𝙍. 🎉\n\n𝘼𝙉𝙎𝙒𝙀𝙍 𝙏𝙃𝙀 𝙈𝙀𝙎𝙎𝘼𝙂𝙀 𝘼𝘽𝙊𝙑𝙀 𝙏𝙊 𝙆𝙉𝙊𝙒 𝙔𝙊𝙐𝙍 𝘼𝙉𝙎𝙒𝙀𝙍\n\n${wm}`, fkontak, m),
/*await conn.sendHydrated(m.chat, `⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️`, `𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝙀 𝘼 𝙀𝙎𝙎𝘼 𝙈𝙀𝙉𝙎𝘼𝙂𝙀𝙈 𝙋𝘼𝙍𝘼 𝙂𝘼𝙉𝙃𝘼𝙍. 🎉\n\n𝘼𝙉𝙎𝙒𝙀𝙍 𝙏𝙃𝙀 𝙈𝙀𝙎𝙎𝘼𝙂𝙀 𝘼𝘽𝙊𝙑𝙀 𝙏𝙊 𝙆𝙉𝙊𝙒 𝙔𝙊𝙐𝙍 𝘼𝙉𝙎𝙒𝙀𝙍`, null, md, '𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿', null, null, [ 
['𝙏𝙤𝙥𝙨 | 𝙍𝙖𝙣𝙠𝙞𝙣𝙜 🏆', `${usedPrefix}top`],
['𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', `${usedPrefix}menu`]
], m)*/, math, 4,
  
setTimeout(() => { 
if (global.math[id]) conn.reply(m.chat, `${lenguajeGB['smsAvisoAG']()}𝙎𝘼𝘾𝘼𝘽𝙊𝙐 𝙊 𝙏𝙀𝙈𝙋𝙊!!\n𝘼 𝙍𝙀𝙎𝙋𝙊𝙎𝙏𝘼 𝙀 *${math.result}*\n\n𝙏𝙄𝙈𝙀 𝙄𝙎 𝙐𝙋!!\n𝙏𝙃𝙀 𝘼𝙉𝙎𝙒𝙀𝙍 𝙄𝙎 *${math.result}*`, m)
//conn.sendButton(m.chat, `${lenguajeGB['smsAvisoAG']()}𝘼𝘾𝘼𝘽𝙊𝙐 𝙊 𝙏𝙀𝙈𝙋𝙊!!\n𝘼 𝙍𝙀𝙎𝙋𝙊𝙎𝙏𝘼 𝙀 *${math.result}*\n\n𝙏𝙄𝙈𝙀 𝙄𝙎 𝙐𝙋!!\n𝙏𝙃𝙀 𝘼𝙉𝙎𝙒𝙀𝙍 𝙄𝙎 *${math.result}*`, wm, null, [['𝙄𝙣𝙩𝙚𝙣𝙩𝙖𝙧 𝙙𝙚 𝙣𝙪𝙚𝙫𝙤 | 𝙏𝙧𝙮 𝙖𝙜𝙖𝙞𝙣', `${usedPrefix + command} ${math.mode}`], ['𝙈𝙚𝙣𝙪 𝙅𝙪𝙚𝙜𝙤𝙨 | 𝙂𝙖𝙢𝙚𝙨 𝙈𝙚𝙣𝙪 🎡', `/juegosmenu`]], global.math[id][0])
