...
⊜ *Tipo de registro »* ${user.registered === true ? `_${user.registroC === true ? 'Registro Completo 🗂️' : 'Registro Rápido 📑'}_` : '❌ _Sem registro_'}
⊜ *Meu estado »* ${typeof user.miestado !== 'string' ? '❌ _' + usedPrefix + 'miestado_' : '_Meu estado ' + user.miestado + '_'}
...
⊜ *Passa tempo(s)* ➺ ${user.pasatiempo === 0 ? '*Sem Registro*' : user.pasatiempo + '\n'}
...
┃ *Reporte com este comando se tiver*
┃ *Falhas para resolver!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
*╭━━━[ CONFIGURAÇÕES - CHATS ]━━━⬣*
┃ *Configurar se você é Proprietário e/ou*
┃ *Admin!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
*╭━━━[ ÁUDIO 🔊 ]━━⬣*
┃ *Visite o Menu de Áudio!!*
┃ *Desfrute de uma grande variedade*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
┃🛠️ _${usedPrefix}calc *operação matemática*_
┃🛠️ _${usedPrefix}del *responder à mensagem do bot*_
┃🛠️ _${usedPrefix}qrcode *texto*_
┃🛠️ _${usedPrefix}readmore *texto1|texto2*_
┃🛠️ _${usedPrefix}spamwa *numero|texto|quantidade*_
...
*╭━━━[ FUNÇÃO RPG ]━━⬣*
┃ *Compre, adquira recursos*
┃ *Melhore seu nível e classificação!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃🪅 _${usedPrefix}botemporal *URL* *Quantidade*_
┃🪅 _${usedPrefix}addbot *URL* *Quantidade*_
┃⚗️➺ _${usedPrefix}pase premium_
┃⚗️➺ _${usedPrefix}pass premium_
┃⚗️➺ _${usedPrefix}listapremium | listprem_
┃⚗️➺ _${usedPrefix}transfer *tipo Quantidade @tag*_
┃⚗️➺ _${usedPrefix}dar *tipo Quantidade @tag*_
┃⚗️➺ _${usedPrefix}enviar *tipo Quantidade @tag*_
...
*╭━[ ADESIVOS E FILTROS ]━⬣*
┃ *Faça adesivos ou crie*
┃ *adesivos com filtros!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
┃🎐 _${usedPrefix}dado_
┃🎐 _${usedPrefix}stickermarker *efecto : responder a imagem*_
┃🎐 _${usedPrefix}stickerfilter *efecto : responder a imagem*_
...
┃ *Comandos apenas para Proprietário!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
┃💎➺ _${usedPrefix}addprem | userpremium *@tag* *quantidade*_
┃💎➺ _${usedPrefix}addprem2 | userpremium2 *@tag* *quantidade*_
┃💎➺ _${usedPrefix}addprem3 | userpremium3 *@tag* *quantidade*_
┃💎➺ _${usedPrefix}addprem4 | userpremium4 *@tag* *quantidade*_
...
┃💎➺ _${usedPrefix}adddiamantes *@tag quantidade*_
┃💎➺ _${usedPrefix}addxp *@tag quantidade*_
┃💎➺ _${usedPrefix}darcoins *@tag quantidade*_
*╰━━━━━━━━━━━━⬣*`.trim()
