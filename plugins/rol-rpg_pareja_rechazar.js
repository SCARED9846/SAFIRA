...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 SΛFIRΛ-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
...
if(!text && !m.quoted) return await conn.reply(m.chat, `${mg}𝙈𝘼𝙍𝙌𝙐𝙀 𝘼 𝙋𝙀𝙎𝙎𝙊𝘼 𝙌𝙐𝙀 𝙑𝙊𝘾𝙀̂ 𝙉𝙀𝙂𝘼𝙍 𝙊 𝘾𝘼𝙎𝘼𝙈𝙀𝙉𝙏𝙊\n\n𝙏𝘼𝙂 𝙏𝙃𝙀 𝙋𝙀𝙍𝙎𝙊𝙉 𝙔𝙊𝙐 𝙒𝘼𝙉𝙏 𝙏𝙊 𝙍𝙀𝙅𝙀𝘾𝙏 𝘼𝙎 𝘼 𝙋𝘼𝙍𝙏𝙉𝙀𝙍`, fkontak,  m)
...
return await conn.reply(m.chat, `*𝙑𝙊𝘾𝙀̂ 𝙉𝘼̃𝙊 𝙋𝙊𝘿𝙀 𝙏𝙀𝙍𝙈𝙄𝙉𝘼𝙍 *${tu}* 𝙎𝙄 𝙉𝙄𝙉𝙂𝙐𝙉𝙊 𝙎𝙀 𝙃𝘼 𝘿𝙀𝘾𝙇𝘼𝙍𝘼𝘿𝙊, 𝙎𝙀 𝙉𝙄𝙉𝙂𝙐𝙀́𝙈 𝙎𝙀 𝘿𝙀𝘾𝙇𝘼𝙍𝙊𝙐 𝘼 𝙑𝙊𝘾𝙀̂, 𝘿𝙀𝘾𝙇𝘼𝙍𝙀-𝙎𝙀 𝙋𝘼𝙍𝘼 𝘼𝙇𝙂𝙐𝙀́𝙈 𝙑𝙊𝘾𝙀̂ 𝙋𝙊𝘿𝙀𝙍𝘼 𝙏𝙀𝙍𝙈𝙄𝙉𝘼𝙍.\n\n𝙔𝙊𝙐 𝘾𝘼𝙉𝙉𝙊𝙏 𝘿𝙀𝘾𝙇𝙄𝙉𝙀 𝙄𝙁 𝙉𝙊𝘽𝙊𝘿𝙔 𝙃𝘼𝙎 𝘿𝙀𝘾𝙇𝘼𝙍𝙀𝘿, 𝘿𝙀𝘾𝙇𝘼𝙍𝙀 𝙒𝙄𝙏𝙃 *${tu}* 𝙏𝙊 𝙎𝘼𝙔 𝙄𝙁 𝙔𝙊𝙐 𝘼𝘾𝘾𝙀𝙋𝙏 𝙊𝙍 𝙍𝙀𝙅𝙀𝘾𝙏 𝙔𝙊𝙐`, fkontak,  m, 
...
return await conn.reply(m.chat, `😿 𝙇𝘼𝙈𝙀𝙉𝙏𝙊 *${yo}* 𝙉𝙀𝙂𝙊𝙐 𝙀𝙉𝙏𝙍𝘼𝙍 𝙀𝙈 𝙐𝙈 𝙍𝙀𝙇𝘼𝘾𝙄𝙊𝙉𝘼𝙈𝙀𝙉𝙏𝙊 𝘾𝙊𝙈 𝙑𝙊𝘾𝙀̂ *${tu}*\n𝙉𝘼̃𝙊 𝙁𝙄𝙌𝙐𝙀 𝙏𝙍𝙄𝙎𝙏𝙀, 𝙑𝙊𝘾𝙀̂ 𝘼𝙄𝙉𝘿𝘼 𝙋𝙊𝘿𝙀 𝙁𝘼𝙕𝙀𝙍 𝙈𝙐𝙄𝙏𝘼𝙎 𝘾𝙊𝙄𝙎𝘼𝙎. 😉🌟 🍃\n\n𝙏𝙃𝙀𝙍𝙀 𝘼𝙍𝙀 𝙉𝙊 𝙍𝙀𝘼𝙎𝙊𝙉𝙎 𝙁𝙊𝙍 𝙏𝙃𝙀𝙈 𝙏𝙊 𝘽𝙀 𝘼 𝘾𝙊𝙐𝙋𝙇𝙀, 𝘿𝙊𝙉'𝙏 𝘽𝙀 𝘿𝙄𝙎𝘾𝙊𝙐𝙍𝘼𝙂𝙀𝘿\n\n*${tu} 💔 ${yo}*\n\n${wm}`, fkontak,  m, 
...
handler.command = /^(negar|cancelar|decline)$/i
handler.group = true
