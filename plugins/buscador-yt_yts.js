...
if (!text) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝙀𝙎𝘾𝙍𝙀𝙑𝘼 𝙊 𝙉𝙊𝙈𝙀 𝘿𝙀 𝙐𝙈 𝙑𝙄́𝘿𝙀𝙊 𝙊𝙐 𝘾𝘼𝙉𝘼𝙇 𝙉𝙊 𝙔𝙊𝙐𝙏𝙐𝘽𝙀\n\n𝙒𝙍𝙄𝙏𝙀 𝙏𝙃𝙀 𝙉𝘼𝙈𝙀 𝙊𝙁 𝘼 𝙔𝙊𝙐𝙏𝙐𝘽𝙀 𝙑𝙄𝘿𝙀𝙊 𝙊𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇`, fkontak,  m)
try {
let vids_ = { 
from: m.sender, 
urls: [] 
...
let textoInfo = `${lenguajeGB['smsAvisoIIG']()}𝙋𝙊𝘿𝙀 𝘽𝘼𝙄𝙓𝘼𝙍 𝙊 𝙑𝙄́𝘿𝙀𝙊 𝙌𝙐𝙀 𝙌𝙐𝙀𝙍 𝘿𝙀𝙎𝙎𝘼 𝙁𝙊𝙍𝙈𝘼:
...
return `[${i + 1}]\n❤️꙰༻ *TÍTULO:*  ${v.title}
⁖🩵꙰༻ *ENLACE:* ${v.url}
⁖💜꙰༻ *DURAÇÃO:* ${v.timestamp}
⁖💚꙰༻ *UPLOAD:* ${v.ago}
⁖🧡꙰༻ *VISUALIZAÇÕES:* ${v.views}`}).join('\n\n••••••••••••••••••••••••••••••••••••\n\n')
