...
if (!args || !args[0]) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝙄𝙉𝘿𝙄𝙌𝙐𝙀 𝙊 𝙇𝙄𝙉𝙆 𝘿𝙊 𝙑𝙄́𝘿𝙀𝙊 𝘿𝙊 𝙔𝙊𝙐𝙏𝙐𝘽𝙀 𝙋𝘼𝙍𝘼 𝘽𝘼𝙄𝙓𝘼𝙍 𝙉𝙊 𝙁𝙊𝙍𝙈𝘼𝙏𝙊 𝘿𝙀 𝘿𝙊𝘾𝙐𝙈𝙀𝙉𝙏𝙊\n𝙀𝙓𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} https://youtu.be/85xI8WFMIUY*\n\n𝙀𝙉𝙏𝙀𝙍 𝙏𝙃𝙀 𝙔𝙊𝙐𝙏𝙐𝘽𝙀 𝙇𝙄𝙉𝙆 𝙏𝙊 𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿 𝙏𝙃𝙀 𝘼𝙐𝘿𝙄𝙊 𝘿𝙊𝘾𝙐𝙈𝙀𝙉𝙏\n𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} https://youtu.be/c5gJRzCi0f0*`, fkontak,  m)

await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}𝙎𝙀𝙐 𝘿𝙊𝘾𝙐𝙈𝙀𝙉𝙏𝙊 𝘿𝙀 𝘼𝙐𝘿𝙄𝙊 𝙀𝙎𝙏𝘼 𝙌𝙐𝘼𝙎𝙀 𝙋𝙍𝙊𝙉𝙏𝙊, 𝙀𝙎𝙋𝙀𝙍𝙀 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍\n\n𝙎𝙊𝙊𝙉 𝙔𝙊𝙐 𝙒𝙄𝙇𝙇 𝙃𝘼𝙑𝙀 𝙔𝙊𝙐𝙍 𝘼𝙐𝘿𝙄𝙊 𝘿𝙊𝘾𝙐𝙈𝙀𝙉𝙏, 𝙋𝙇𝙀𝘼𝙎𝙀 𝙒𝘼𝙄𝙏`, fkontak,  m)
try {
let q = '128kbps'
let v = args[0]
...
await conn.reply(m.chat, '*ERROR, TENTE NOVAMENTE*', m)}
}}
