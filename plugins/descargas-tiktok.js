...
if (!text) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝙄𝙉𝘿𝙄𝙌𝙐𝙀 𝙊 𝙇𝙄𝙉𝙆 𝙋𝘼𝙍𝘼 𝘽𝘼𝙄𝙓𝘼𝙍 𝙊 𝙑𝙄́𝘿𝙀𝙊 𝘿𝙊 𝙏𝙄𝙆𝙏𝙊𝙆,\n𝙀𝙓𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} https://vm.tiktok.com/ZMLEPnruc/?k=1*\n\n𝙔𝙊𝙐 𝙈𝙐𝙎𝙏 𝙀𝙉𝙏𝙀𝙍 𝘼 𝙏𝙄𝙆𝙏𝙊𝙆 𝙇𝙄𝙉𝙆 𝙏𝙊 𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿 𝙏𝙃𝙀 𝙑𝙄𝘿𝙀𝙊\n𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} https://vm.tiktok.com/ZMLEPnruc/?k=1*`, fkontak,  m)
if (!/(?:https:?\/{2})?(?:w{3}|vm|vt|t)?\.?tiktok.com\/([^\s&]+)/gi.test(text)) return conn.reply(m.chat, `${lenguajeGB['smsAvisoFG']()}A 𝙐𝙍𝙇 𝘿𝙊 𝙏𝙄𝙆𝙏𝙊𝙆 𝙋𝘼𝙍𝙀𝘾𝙀 𝙎𝙀𝙍 𝙄𝙉𝙑𝘼́𝙇𝙄𝘿𝘼\n\n𝙏𝙃𝙀 𝙏𝙄𝙆𝙏𝙊𝙆 𝙇𝙄𝙉𝙆 𝙄𝙎 𝙄𝙉𝘾𝙊𝙍𝙍𝙀𝘾𝙏, 𝙈𝘼𝙆𝙀 𝙎𝙐𝙍𝙀 𝙄𝙏 𝙄𝙎 𝙑𝘼𝙇𝙄𝘿`, fkontak,  m)  
